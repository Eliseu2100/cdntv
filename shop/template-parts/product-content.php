<?php $skip_min_height = false; ?><section class="u-align-center u-clearfix u-section-1" id="sec-c6b1">
...
c6.177,6.18,9.262,14.271,9.262,22.366C354.708,234.018,351.617,242.115,345.441,248.292z"></path></svg>
        ...
        <a href="#sec-5f72" class="u-border-2 u-border-black u-btn u-button-style u-hover-black u-none u-product-control u-text-black u-text-hover-white u-btn-1  u-payment-button u-add-to-cart-link" data-product-button-click-type="add-to-cart" data-product-id="<?php echo $productId; ?>" data-product="<?php echo $productJson; ?>"><!--product_button_content-->Adicionar ao Carrinho<!--/product_button_content--></a><!--/product_button-->
      </div>
